...
ImageProvider<Object> getImageProviderSync(
  String? imageUrl, {
  String? fallbackUrl,
  String placeholderUrl = "assets/app_icon.png",
}) {
...
class LoadImageCached extends StatefulWidget {
  ...
  const LoadImageCached({
    ...
    this.placeholderUrl = "assets/app_icon.png",
...
class _LoadImageCachedState extends State<LoadImageCached> {
  ...
  Widget _placeholderWidget() {
    ...
    if (widget.placeholderUrl == "assets/app_icon.png") {
      final double width = widget.width ?? 50.0;
      return Container(
        ...
        child: Icon(
          ...
          size: (width * 0.45).clamp(16.0, 72.0),
        ),
      );
    }
  ...
  Widget _buildImageContent() {
    final placeholder = _placeholderWidget();
