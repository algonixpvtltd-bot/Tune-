...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Some plugins could not be installed. You can still use Tune — plugins will be retried on next launch.'**
