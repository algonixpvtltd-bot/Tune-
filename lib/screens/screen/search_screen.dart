                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Icon(MingCuteIcons.mgc_plugin_2_line,
          ...
          child: AnimatedContainer(
            ...
            child: AnimatedSize(
              ...
              child: Row(
                ...
                children: [
                  if (isSelected) ...[
                    const Icon(MingCuteIcons.mgc_check_line,
        ...
        if (state is SearchSuggestionLoaded) {
          ...
          if (combined.isEmpty && textEditingController.text.isEmpty) {
            return SliverFillRemaining(
                ...
                child: SignBoardWidget(
                    ...
                    icon: MingCuteIcons.mgc_keyboard_line));
          }
          if (combined.isEmpty) {
            return SliverFillRemaining(
                hasScrollBody: false,
          ...
          final children = <Widget>[
            ...
            if (dbList.isNotEmpty) ...[
              _buildSuggestionSectionHeader('Recent', MingCuteIcons.mgc_history_line),
            ...
            if (apiList.isNotEmpty) ...[
              _buildSuggestionSectionHeader(
                  'Suggestions', MingCuteIcons.mgc_search_2_line),
            ...
            if (entityList.isNotEmpty) ...[
              _buildSuggestionSectionHeader(
                  'Top Results', MingCuteIcons.mgc_sparkles_2_line),
            ...
            children: [
              ...
              if (isHistory)
                GestureDetector(
                    ...
                    child: Icon(MingCuteIcons.mgc_close_fill,
                        color:
                ...
                GestureDetector(
                    ...
                    child: Icon(MingCuteIcons.mgc_arrow_left_up_line,
                        color:
                            Default_Theme.primaryColor1.withValues(alpha: 0.4),
                        size: 18))
            ],
...
class _EntitySuggestionTile extends StatelessWidget {
  ...
  Widget _placeholder() => Container(
      ...
      child: Icon(MingCuteIcons.mgc_search_line,
