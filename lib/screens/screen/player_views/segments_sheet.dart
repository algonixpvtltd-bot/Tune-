...
class _SegmentsSheetBodyState extends State<_SegmentsSheetBody> {
  ...
  IconData _segmentIcon(SegmentType type) {
    return switch (type) {
      SegmentType.intro => MingCuteIcons.mgc_play_circle_line,
      SegmentType.outro => MingCuteIcons.mgc_stop_circle_line,
      SegmentType.chapter => MingCuteIcons.mgc_book_2_line,
      SegmentType.sponsor => MingCuteIcons.mgc_announcement_line,
      SegmentType.selfPromo => MingCuteIcons.mgc_microphone_fill,
      SegmentType.interaction => MingCuteIcons.mgc_chat_1_line,
      SegmentType.musicOfftopic => MingCuteIcons.mgc_music_line,
      SegmentType.filler => MingCuteIcons.mgc_more_1_line,
      SegmentType.unknown => MingCuteIcons.mgc_hashtag_line,
    };
  }
