                ...
                children: [
                  GestureDetector(
                    ...
                    child: const Padding(
                        ...
                        child: Icon(MingCuteIcons.mgc_minus_circle_fill,
                            color: Colors.white, size: 28)),
                  ),
                  InkWell(
                  ...
                  GestureDetector(
                    ...
                    child: const Padding(
                        padding: EdgeInsets.all(8),
                        child: Icon(MingCuteIcons.mgc_add_circle_fill,
                            color: Colors.white, size: 28)),
                  ),
                  Container(
                      width: 1,
              ...
              Row(
                ...
                children: [
                  IconButton(
                    ...
                    icon: const Icon(MingCuteIcons.mgc_skip_previous_fill,
                        color: Colors.white),
                  ...
                  IconButton(
                    ...
                    icon: const Icon(MingCuteIcons.mgc_skip_forward_fill,
                        color: Colors.white),
                    iconSize: isDesktop ? 40 : 36,
                  ),
                ],
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(MingCuteIcons.mgc_playlist_fill,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMenuItem(
              icon: MingCuteIcons.mgc_delete_3_line,
