          ...
          child: Row(
            children: [
              ...
              if (displayedTracks.isNotEmpty) ...[
                _ActionChipButton(
                  icon: MingCuteIcons.mgc_shuffle_line,
            ...
            child: Column(
              ...
              children: [
                SignBoardWidget(
                    ...
                    icon: MingCuteIcons.mgc_music_2_line),
                ...
                if (!LocalMusicService.isMobile)
                  Padding(
                    ...
                    child: FilledButton.icon(
                      ...
                      icon: const Icon(MingCuteIcons.mgc_new_folder_line, size: 20),
                      label: Text(
                ...
                OutlinedButton.icon(
                  ...
                  icon: const Icon(MingCuteIcons.mgc_refresh_2_line, size: 20),
                ...
                return Tooltip(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(
                          MingCuteIcons.mgc_folder_2_fill,
                          color: Default_Theme.primaryColor2
      ...
      actions: [
        ...
        if (!_isSearch && !LocalMusicService.isMobile)
          IconButton(
            ...
            icon: const Icon(MingCuteIcons.mgc_new_folder_line,
                color: Default_Theme.primaryColor1),
            onPressed: () =>
                context.read<LocalMusicCubit>().addFolderViaPicker(),
          ),
        IconButton(
          ...
          icon: Icon(_isSearch ? Icons.close : MingCuteIcons.mgc_search_2_line,
              color: Default_Theme.primaryColor1),
                  ...
                  .map(
                    (playlist) => Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(MingCuteIcons.mgc_playlist_2_line,
                              size: 14,
                              color: Default_Theme.primaryColor2
