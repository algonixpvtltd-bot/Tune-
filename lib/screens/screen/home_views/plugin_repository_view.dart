                  ...
                  if (state is PluginRepositoryLoading) {
                    ...
                    if (state.repositories.isEmpty) {
                      return SignBoardWidget(
                        ...
                        icon: MingCuteIcons.mgc_cloud_snow_line,
                      );
                    }
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Icon(MingCuteIcons.mgc_cloud_line,
                  ...
                  Material(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Icon(MingCuteIcons.mgc_copy_2_line,
                                size: 14,
                                color: Default_Theme.primaryColor2
                          ...
                          children: [
                            _Badge(
                                ...
                                label: l10n.pluginRepositoryPluginsCount(
                                    repo.plugins.length)),
                            _Badge(
                                icon: MingCuteIcons.mgc_clock_2_line,
                                label: generatedDate),
                          ],
                        ),
                      ),
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Icon(MingCuteIcons.mgc_delete_2_line,
