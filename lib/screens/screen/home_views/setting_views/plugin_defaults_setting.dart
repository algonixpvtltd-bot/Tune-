          ...
          SettingCard(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    const SettingIconBox(icon: MingCuteIcons.mgc_plugin_2_line),
          ...
          SettingCard(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    const SettingIconBox(icon: MingCuteIcons.mgc_sort_ascending_line),
                    const SizedBox(width: 14),
                    Expanded(
                      child: Text(
          ...
          SettingCard(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    const SettingIconBox(icon: MingCuteIcons.mgc_align_center_fill),
                    const SizedBox(width: 14),
                    Expanded(
                      child: Text(
          ...
          SettingCard(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    const SettingIconBox(icon: MingCuteIcons.mgc_search_fill),
                    const SizedBox(width: 14),
                    Expanded(
                      child: Text(
