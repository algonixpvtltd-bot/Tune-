...
class _AppUISettingsState extends State<AppUISettings> {
  ...
  void _showProfileNameDialog(BuildContext context, String currentName) {
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                if (text.isNotEmpty) {
                  context.read<SettingsCubit>().setProfileName(text);
                }
                Navigator.pop(context);
              },
              child: const Text('Save', style: TextStyle(color: Default_Theme.accentColor2, fontWeight: FontWeight.bold)),
            ),
          ],
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<SettingsCubit, SettingsState>(
        buildWhen: (prev, curr) =>
            prev.profileName != curr.profileName ||
        ...
        builder: (context, state) {
          return ListView(
            ...
            children: [
              const SettingSectionHeader(label: 'Profile'),
              SettingCard(
                children: [
                  SettingNavTile(
                    ...
                    onTap: () => _showProfileNameDialog(context, state.profileName),
                  ),
                ],
              ),
              ...
              SettingCard(
                children: [
                  SettingToggleTile(
                    icon: MingCuteIcons.mgc_play_circle_line,
