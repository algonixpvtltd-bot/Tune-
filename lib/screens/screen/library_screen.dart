                  ...
                  SliverFillRemaining(
                    child: Center(
                      child: SignBoardWidget(
                        ...
                        icon: MingCuteIcons.mgc_playlist_fill,
                      ),
                    ),
                  ),
                ],
      ...
      title: Row(
        children: [
          ...
          IconButton(
            ...
            icon: Icon(
              _isSearching ? MingCuteIcons.mgc_close_fill : MingCuteIcons.mgc_search_line,
              size: 24,
              color: _isSearching
                  ? Default_Theme.accentColor2
          ...
          IconButton(
            ...
            icon: const Icon(MingCuteIcons.mgc_add_fill,
          ...
          IconButton(
            ...
            icon: const Icon(AppIcons.fileImportSolid,
