      ...
      builder: (context, state) {
        ...
        if (state.availablePlugins.isEmpty) {
          return SignBoardWidget(
              message: l10n.pluginManagerEmpty, icon: MingCuteIcons.mgc_plugin_2_line);
        }
    ...
    return AppBar(
      ...
      actions: [
        BlocBuilder<PluginBloc, PluginState>(
          builder: (context, state) {
            ...
            return IconButton(
              ...
              icon: const Icon(MingCuteIcons.mgc_refresh_2_line,
        ...
        IconButton(
          ...
          icon: const Icon(MingCuteIcons.mgc_add_circle_line,
    ...
    if (plugins.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(MingCuteIcons.mgc_ghost_line,
                size: 48,
...
class _PluginCard extends StatelessWidget {
  ...
  static IconData _pluginTypeIcon(PluginType type) {
    return switch (type) {
      PluginType.contentResolver => MingCuteIcons.mgc_music_2_fill,
      PluginType.chartProvider => MingCuteIcons.mgc_chart_bar_fill,
      PluginType.lyricsProvider => MingCuteIcons.mgc_align_center_fill,
      PluginType.searchSuggestionProvider => MingCuteIcons.mgc_search_fill,
      PluginType.contentImporter => MingCuteIcons.mgc_file_import_fill,
    };
  }
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: req.isSecret
                              ? Icon(MingCuteIcons.mgc_eye_close_line,
                                  color: Default_Theme.primaryColor1
