...
class _ArtistViewState extends State<ArtistView> {
                ...
                sliver: SliverPersistentHeader(
                  ...
                  delegate: _SliverAppBarDelegate(
                    TabBar(
                      ...
                      indicatorSize: isAndroidPlatform
                          ? TabBarIndicatorSize.label
                          : TabBarIndicatorSize.tab,
                      indicator: isAndroidPlatform
                          ? const UnderlineTabIndicator(
                              borderSide: BorderSide(
                                  color: Default_Theme.accentColor2, width: 3),
                      ...
                      labelColor:
                          isAndroidPlatform ? Colors.white : Default_Theme.accentColor2,
                      unselectedLabelColor: isAndroidPlatform
    ...
    if (topTracks.isEmpty) {
      return const Center(
          child: SignBoardWidget(
              message: 'No top songs available', icon: MingCuteIcons.mgc_music_2_line));
    }
  ...
  Widget _buildAlbumsTab(List<AlbumSummary> albums, DetailStatus status) {
    if (albums.isEmpty) {
      return const Center(
          child: SignBoardWidget(
              message: 'No albums available', icon: MingCuteIcons.mgc_album_line));
    }
