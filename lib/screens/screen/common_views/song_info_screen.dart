...
class _SongInfoScreenState extends State<SongInfoScreen> {
  ...
  IconData _getSourceIcon() {
    return MingCuteIcons.mgc_plugin_2_fill;
  }
      ...
      children: [
        ...
        _GlassCard(
          children: [
            ...
            _DetailRow(
              icon: MingCuteIcons.mgc_microphone_fill,
            ...
            if (song.album?.title != null) ...[
              const _DetailDivider(),
              _DetailRow(
                icon: MingCuteIcons.mgc_album_fill,
            ...
            const _DetailDivider(),
            _DetailRow(
              icon: MingCuteIcons.mgc_time_fill,
        ...
        _GlassCard(
          children: [
            ...
            const _DetailDivider(),
            _DetailRow(
              icon: MingCuteIcons.mgc_plugin_2_fill,
        ...
        const SizedBox(height: 16),
        _ActionButton(
          icon: MingCuteIcons.mgc_refresh_3_fill,
        ...
        Row(
          children: [
            ...
            Expanded(
              child: _ActionButton(
                icon: MingCuteIcons.mgc_link_3_fill,
        ...
        if (song.url != null && song.url!.isNotEmpty)
          _ActionButton(
            icon: MingCuteIcons.mgc_external_link_fill,
