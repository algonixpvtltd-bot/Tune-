      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(MingCuteIcons.mgc_link_fill,
...
class _CollectionHeader extends StatelessWidget {
  ...
  Widget _thumbPlaceholder() => Container(
        ...
        child: Icon(MingCuteIcons.mgc_playlist_fill,
          ...
          child: ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              backgroundColor:
                  Default_Theme.primaryColor1.withValues(alpha: 0.1),
              valueColor:
                  AlwaysStoppedAnimation(Default_Theme.accentColor2),
            ),
          ),
        ),
...
class _ResolvingTrackTile extends StatelessWidget {
  ...
  Widget _miniPlaceholder() => Container(
      color: Default_Theme.primaryColor1.withValues(alpha: 0.08),
      child: Icon(MingCuteIcons.mgc_music_2_fill,
                      ...
                      children: [
                        ...
                        if (effective != null)
                          Padding(
                            ...
                            child: Row(
                              children: [
                                const Icon(MingCuteIcons.mgc_arrows_right_line,
                                    size: 14,
                                    color: Default_Theme.accentColor2),
                                const SizedBox(width: 6),
                                Expanded(
