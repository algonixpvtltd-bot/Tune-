            ...
            builder: (context, pluginState) {
              ...
              return ListView(
                ...
                children: [
                  ...
                  _ImportFromBtn(
                    btnName: AppLocalizations.of(context)!.importTuneFiles,
                    btnIcon: MingCuteIcons.mgc_file_import_fill,
                    onClickFunc: () => _importBloomeeFile(context),
                  ),
                  const SizedBox(height: 10),
                  _ImportFromBtn(
                    btnName: AppLocalizations.of(context)!.importM3UFiles,
                    btnIcon: MingCuteIcons.mgc_playlist_2_line,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(
              MingCuteIcons.mgc_plugin_2_line,
              size: 48,
    ...
    return showDialog<String>(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        title: Text(
          ...
          style: Default_Theme.primaryTextStyle.merge(
            TextStyle(color: Default_Theme.primaryColor1, fontSize: 18),
          ),
        ),
        content: TextField(
