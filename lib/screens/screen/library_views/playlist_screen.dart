          ...
          if (state.status == CurrentPlaylistLoadStatus.error) {
            return Center(
                child: SignBoardWidget(
                    ...
                    icon: MingCuteIcons.mgc_alert_line));
          }
                    ...
                    SliverFillRemaining(
                      ...
                      child: Center(
                          child: SignBoardWidget(
                              ...
                              icon: MingCuteIcons.mgc_playlist_line)),
                    )
                  else
                    SliverPadding(
        ...
        child: ClipRRect(
          ...
          child: imageUrl.isEmpty
              ? FractionallySizedBox(
                  widthFactor: 0.3,
                  heightFactor: 0.3,
                  child: Icon(MingCuteIcons.mgc_music_2_line,
  ...
  Widget _buildActions(CurrentPlaylistState state, Color fgColor, Color bgColor,
    ...
    return RepaintBoundary(
      child: Row(
        ...
        children: [
          _buildActionIcon(
              MingCuteIcons.mgc_shuffle_line,
          ...
          const SizedBox(width: 12),
          _buildActionIcon(MingCuteIcons.mgc_more_2_line, l10n.buttonMore,
