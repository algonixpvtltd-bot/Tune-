...
class _AudioPlayerViewState extends State<AudioPlayerView>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isAndroidPlatform
          ? const Color(0xFF040406) // Deep obsidian black
          : const Color.fromARGB(255, 12, 4, 9),
          ...
          IconButton(
            ...
            icon: Icon(
                isAndroidPlatform
                    ...
                    : MingCuteIcons.mgc_list_check_3_line,
                size: 22,
                ...
                child: ClipRRect(
                  ...
                  child: LoadImageCached(
                    ...
                    customPlaceholder: Container(
                      ...
                      alignment: Alignment.center,
                      child: Icon(
                        MingCuteIcons.mgc_music_2_line,
      ...
      child: StreamBuilder<ProgressBarStreams>(
        ...
        builder: (context, snapshot) {
          ...
          return GradientProgressBar.fromAccentColors(
            ...
            inactiveTrackColor: isAndroidPlatform
        ...
        _buildControlColumn(
          top: IconButton(
            icon: Icon(
                isAndroidPlatform
                    ? Icons.alarm_rounded
                    : MingCuteIcons.mgc_alarm_1_line,
                color: Default_Theme.primaryColor1,
                size: 28),
          ...
          top: IconButton(
            icon: Icon(
                isAndroidPlatform
                    ...
                    : MingCuteIcons.mgc_skip_previous_fill,
                color: Default_Theme.primaryColor1,
                size: 35),
          ...
          bottom: IconButton(
            icon: Icon(
                isAndroidPlatform
                    ...
                    : MingCuteIcons.mgc_align_center_line,
                color: Default_Theme.primaryColor1,
                size: 24),
            onPressed: () {
          ...
          top: IconButton(
            icon: Icon(
                isAndroidPlatform
                    ...
                    : MingCuteIcons.mgc_skip_forward_fill,
                color: Default_Theme.primaryColor1,
                size: 35),
        ...
        return PopupMenuButton(
          ...
          child: Icon(
            loopMode == LoopMode.off
                ? (isAndroidPlatform ? Icons.repeat_rounded : MingCuteIcons.mgc_repeat_line)
                : loopMode == LoopMode.one
                    ? (isAndroidPlatform ? Icons.repeat_one_rounded : MingCuteIcons.mgc_repeat_one_line)
                    : (isAndroidPlatform ? Icons.repeat_on_rounded : MingCuteIcons.mgc_repeat_fill),
        ...
        return IconButton(
          icon: Icon(
            isAndroidPlatform
                ...
                : MingCuteIcons.mgc_shuffle_2_fill,
            color: isShuffle
                ? Default_Theme.accentColor1
                : Default_Theme.primaryColor1,
            size: 28,
    ...
    return BlocBuilder<MiniPlayerCubit, MiniPlayerState>(
      builder: (context, state) {
        ...
        if (state.isLoading || state.isResolving) {
          ...
          child = const Icon(AppIcons.rotateRightSolid,
          ...
          gradient: RadialGradient(
            colors: [
              (_cachedColor ?? const Color.fromARGB(255, 163, 44, 115))
                  .withValues(alpha: isAndroidPlatform ? 0.50 : 0.35),
              Colors.transparent,
            ],
            center: Alignment.center,
            radius: isAndroidPlatform ? 0.85 : 0.70,
          ),
        ),
      ),
    );
