        ...
        child: Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(isAndroidPlatform ? 20 : 16),
              boxShadow: isAndroidPlatform
                  ? [
                      BoxShadow(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        if (isDesktop)
                          _ControlButton(
                            icon: isAndroidPlatform
                                ? Icons.skip_previous_rounded
                                : AppIcons.backwardStepSolid,
                            size: 20,
                            onPressed: () {
                              HapticFeedback.lightImpact();
                              context
...
class _Artwork extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: size,
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(isAndroidPlatform ? 14 : 12),
        boxShadow: [
          BoxShadow(
      ...
      child: Container(
        ...
        child: Center(
          child: AnimatedSwitcher(
            ...
            child: Icon(
              state.isPlaying
                  ? (isAndroidPlatform ? Icons.pause_rounded : MingCuteIcons.mgc_pause_fill)
                  : (isAndroidPlatform ? Icons.play_arrow_rounded : MingCuteIcons.mgc_play_fill),
