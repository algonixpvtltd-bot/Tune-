...
class _ShortcutIndicatorState extends State<_ShortcutIndicator>
  ...
  Widget _buildIcon(ShortcutIndicatorType type) {
    IconData icon = MingCuteIcons.mgc_check_circle_fill;
    ...
    switch (type) {
      case ShortcutIndicatorType.volume:
        ...
        if (level == 0) {
          icon = MingCuteIcons.mgc_volume_off_fill;
      ...
      case ShortcutIndicatorType.mute:
        ...
        icon = isMuted ? MingCuteIcons.mgc_volume_off_fill : MingCuteIcons.mgc_volume_fill;
        color = isMuted
      ...
      case ShortcutIndicatorType.shuffle:
        icon = MingCuteIcons.mgc_shuffle_2_line;
      ...
      case ShortcutIndicatorType.loop:
        ...
        switch (mode) {
          case LoopMode.off:
            icon = MingCuteIcons.mgc_repeat_line;
            color = Colors.white.withValues(alpha: 0.5);
            break;
          case LoopMode.one:
            icon = MingCuteIcons.mgc_repeat_one_line;
