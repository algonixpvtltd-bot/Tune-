                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          if (showSinglePlay ||
                            ...
                            _ActionRow(
                              children: [
                                if (showSinglePlay)
                                  _ActionButton(
                                    icon: MingCuteIcons.mgc_play_circle_fill,
                                ...
                                if (showPlayNext)
                                  _ActionButton(
                                    icon: MingCuteIcons.mgc_square_arrow_right_line,
                          ...
                          _CompactTile(
                            icon: MingCuteIcons.mgc_add_circle_line,
                          ...
                          _CompactTile(
                            icon: MingCuteIcons.mgc_refresh_3_line,
                          ...
                          _CompactTile(
                            icon: MingCuteIcons.mgc_share_forward_line,
