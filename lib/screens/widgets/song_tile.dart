        ...
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isPlaying
                ...
                : Colors.transparent,
            borderRadius: BorderRadius.circular(isAndroidPlatform ? 16 : 14),
          ),
          child: Material(
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    if (isPlaying && isAndroidPlatform)
                      Container(
                        width: 4,
                        height: 24,
                    ...
                    // ── Thumbnail ──
                    ClipRRect(
                      borderRadius: BorderRadius.circular(isAndroidPlatform ? 6 : 10),
                      child: SizedBox(
                        width: isWide ? 86 : 50,
                        height: 50,
