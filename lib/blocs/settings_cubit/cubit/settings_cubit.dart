...
class SettingsCubit extends Cubit<SettingsState> {
  ...
  Future<void> _initSettings() async {
    final results = await Future.wait([
      ...
      // [27] profileName
      _readSetting(
        () => _settingsRepo.getSettingStr(SettingKeys.profileName,
            defaultValue: 'Dhanush U A'),
        SettingKeys.profileName,
      ),
    ]);
    ...
    emit(SettingsState(
      ...
      profileName: (results[27] as String?) ?? 'Dhanush U A',
    ));
  }
  ...
  void setProfileName(String v) {
    _settingsRepo.putSettingStr(SettingKeys.profileName, v);
    emit(state.copyWith(profileName: v));
  }
